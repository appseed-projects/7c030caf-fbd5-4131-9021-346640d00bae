...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-13 15:22`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7c030caf-fbd5-4131-9021-346640d00bae.git
$ cd 7c030caf-fbd5-4131-9021-346640d00bae
```
